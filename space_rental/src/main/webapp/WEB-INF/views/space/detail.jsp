...
" />
					<p class="container">${ fn:replace(host.content, enter, '<br>') }</p>
					<ul class="py-3" style="list-style: none; padding-left: 0px;">
						<li><span class="pr-3 text-black">영업시간</span> <span>${ host.open }</span></li>
						<li><span class="pr-3 text-black">휴무일</span> <span>${ host.holiday }</span></li>
						<li><span class="pr-3 text-black">주차</span> <span>${ host.parking }</span></li>
					</ul>
				</div>
