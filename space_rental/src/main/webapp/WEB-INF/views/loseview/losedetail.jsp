...
<article id="bo_v" style="width:100%">
    ...
    <div id="bo_v_top">
        ...
        <ul class="bo_v_left">
            <li><a href="" class="btn_b01 btn"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> 수정</a></li>            
            <li><a href="" class="btn_b01 btn" onclick="del(this.href); return false;"><i class="fa fa-trash-o" aria-hidden="true"></i> 삭제</a></li>                                            </ul>

        <ul class="bo_v_com">
           
            <li><a href="loselist" class="btn_b01 btn"><i class="fa fa-list" aria-hidden="true"></i> 목록</a></li>
            <li><a href="losewrite" class="btn_b02 btn"><i class="fa fa-pencil" aria-hidden="true"></i> 글쓰기</a></li></ul>            
                    </div>
    <!-- } 게시물 상단 버튼 끝 -->
